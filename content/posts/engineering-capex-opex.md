...
Over the years I've implemented a third way that is good enough for financial purposes AND light enough to not become a burden. And we all know, things that are easy to measure are more likely to be consistently measured.
...
Surprisingly simple: each team fills out a short allocation table every two weeks. 
...
Admittedly, the line between a bugfix and a feature can get blurry at times. But we're all adults, there is some judgment required. And **who better to judge than the people doing the work**.
...
Since the estimates are on a per-team basis, you need a per-team cost. Which, to nobody's surprise, is simply the salary of all the people who were in that team. And teams are quite stable, certainly within a two week period, so it's mostly a set and forget.
...
And for what its worth, our Big Four auditor did this and concluded our approach was acceptable.

## Why it works
The two-minute constraint is a feature rather than a limitation. If you make the reporting burdensome, engineers will either game it or resent it. Two minutes means they'll actually do it, and the social dynamics of doing it as a team over a two week window rather than by task means the estimates are usually good enough without looking like surveillance.
